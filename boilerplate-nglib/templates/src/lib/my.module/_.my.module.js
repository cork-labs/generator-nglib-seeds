(function (angular) {
    ...
    var module = angular.module('<%= config['angular.module'] %>', ['<%= config['angular.module'] %>.templates']);
     ...
     *
     * @description
     * Allows the {@link <%= config['angular.module'] %>.myService myService} service to be configured.
     */
    module.provider('myService', [
        ...
        function myServiceProvider() {
             ...
             *
             * @description
             * Configures the {@link <%= config['angular.module'] %>.myService myService} service.
             *
